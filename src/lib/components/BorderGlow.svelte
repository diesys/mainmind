...
<script lang="ts">
	...
	const transitionStr = $derived(isVisible ? 'opacity 0.2s ease-out' : 'opacity 0.5s ease-in-out');
...
<div
	...
	class="glow-wrap {className}"
	role="presentation"
	style="background:{backgroundColor}; border-radius:{borderRadius}px; transform:translate3d(0,0,0.01px);"
>
	<div
		class="glow-layer border-layer"
